...
def tavily_search(query, search_depth='basic', max_tokens=None):
    """
    ...
    max_tokens (int, optional): The maximum tokens to retrieve in search context. Applicable for advanced search.
    ...
    try:
        ...
        # Advanced search with or without max_tokens
        elif search_depth == 'advanced':
            if max_tokens:
                return tavily.get_search_context(query=query, search_depth=search_depth, max_tokens=max_tokens)
            else:
...
# Example usage
#results = tavily_search("Should I invest in Apple in 2024?", search_depth='advanced')
